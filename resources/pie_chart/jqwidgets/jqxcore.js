...
(function(a) {
 ...
 a.jqx.jqxWidget = function(b, c, f) {
  ...
  a.extend(a.jqx["_" + g].prototype, {
   ...
   _addBarAndLabel: function(o) {
    var n = this;
    var e = a("<label></label");
    e[0].innerHTML = this.placeHolder;
    e.addClass(n.toThemeProperty("jqx-input-label"));
    o.after(e);
    n.label = e;
    var m = a("<span></span>");
    o.after(m);
    m.addClass(n.toThemeProperty("jqx-input-bar"));
    n.bar = m;
    n.bar.css("top", this.host.height())
   }
  });
 ...
 a.extend(a.jqx.mobile, {
  ...
  isTouchDevice: function() {
   ...
   if (c.indexOf("HybridDeviceTouch") != -1) {
    return true
   }
   if (c.indexOf("HybridDeviceMouse") != -1) {
    return false
   }
...
(function(b) {
 ...
 b.jqx.ripple = function(f, e, o) {
  ...
  e.on("mousedown.ripple", function(q) {
   var d = b(f);
   ...
   setTimeout(function() {
    ...
    if (!s.height() && !s.width()) {
     var t = Math.max(d.outerWidth(), d.outerHeight());
     s.css({
      height: t,
      width: t
     })
    ...
    if (o === "checkbox" || o === "radiobutton") {
     ...
     var r = d.width() / 2 - s.width() / 2;
     var u = d.height() / 2 - s.height() / 2;
     s.css({
      top: u + "px",
      left: r + "px"
     }).addClass("animate");
    ...
    var r = q.pageX - d.offset().left - s.width() / 2;
    var u = q.pageY - d.offset().top - s.height() / 2;
    s.css({
     top: u + "px",
     left: r + "px"
    }).addClass("animate")
