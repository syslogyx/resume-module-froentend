app.controller("resumeListCtrl", function (services, AclService, $scope, $http, $location, RESOURCES, $cookieStore, menuService, pagination) {
    ...
    rlc.openAssignInterviewerModal = function ($cdata) {
        ...
        rlc.assignCandidateName = $cdata.first_name + ' ' + ($cdata.middle_name != null ? $cdata.middle_name : '') + ' ' + $cdata.last_name;
    ...
    rlc.openRescheduleModal = function (cdata, data) {
        ...
        if ($scope.interviewRescheduleData.length != null) {
            ...
            $scope.reassignCandidateName = cdata.first_name + ' ' + (cdata.middle_name != null ? cdata.middle_name : '') + ' ' + cdata.last_name;
   ...
   */
    ...
    rlc.viewBgChecklistModal = function (candidateData) {
        ...
        var candidate_name = candidateData.first_name + '_' + (candidateData.middle_name != null ? candidateData.middle_name : '') + '_' + candidateData.last_name;
        ...
        rlc.candidateNameToShowOnModal = candidateData.first_name + ' ' + (candidateData.middle_name != null ? candidateData.middle_name : '') + ' ' + candidateData.last_name;
